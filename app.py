...
# --- 2. SIDEBAR: DOCUMENTATION & LOGIC (LEFT HAND SIDE) ---
with st.sidebar:
    st.title("🛡️ Content Engineer Pro")
    st.subheader("Project Summary")
    st.write("""
    This project is a specialized growth marketing tool that transforms historical 
    campaign data into high-performing variations using a mathematical and semantic bridge.
    """)
