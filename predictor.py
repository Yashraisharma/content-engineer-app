...
def run_page():
    # --- 1. CONFIG & UI ---
    # Try to safely get the key without crashing if the secrets file isn't found
    try:
    ...
    # Define this inside run_page so it has access to the sidebar inputs
...
# If someone runs this file directly instead of through the multi-page app, run it anyway
